...
class TestIntegration(unittest.TestCase):
    def setUp(self):
        ...
        with open(self.input_file, "w", encoding="utf-8-sig") as f:
            ...
            f.write(
                "- Your Highlight on page 10 | Location 100-120 | Added on Friday, October 27, 2023 12:00:00 PM\n\n"
            )
    ...
    def test_deduplication_integration(self):
        ...
        with open(self.input_file, "a", encoding="utf-8-sig") as f:
            f.write("Book Title (Author Name)\n")
            f.write(
                "- Your Highlight on page 10 | Location 100-120 | Added on Friday, October 27, 2023 12:01:00 PM\n\n"
            )
            f.write(
                "This is a sample highlight content.\n"
