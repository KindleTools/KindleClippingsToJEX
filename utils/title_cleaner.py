...
class TitleCleaner:
    ...
    PATTERNS = [
        ...
        r"\s*\(Spanish Edition\)",
        r"\s*\(English Edition\)",
        r"\s*\(Edición española\)",
        r"\s*\(Edición en español\)",
        r"\s*\(French Edition\)",
        r"\s*\(Edition française\)",
        r"\s*\(Version française\)",
        r"\s*\(German Edition\)",
        r"\s*\(Deutsche Ausgabe\)",
        r"\s*\(Italian Edition\)",
        r"\s*\(Edizione italiana\)",
        r"\s*\(Portuguese Edition\)",
        r"\s*\(Edição portuguesa\)",
        r"\s*\(Kindle Edition\)",
        r"\s*\[Print Replica\]",
        r"\s*\[eBook\]",
        r"\s*\(Edition \d+\)",
